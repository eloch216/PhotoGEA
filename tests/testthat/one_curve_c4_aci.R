...
licor_file <- calculate_temperature_response_arrhenius(licor_file, c4_arrhenius_von_caemmerer)

licor_file <- calculate_temperature_response_gaussian(licor_file, c4_peaked_gaussian_von_caemmerer)
