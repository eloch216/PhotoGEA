...
Throughout this vignette, key pieces of advice will be shown in boxes. The final
...
to just make separate user constants for each important piece of metadata. In
other words:
