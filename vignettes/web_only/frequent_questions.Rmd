...
creation of the `exdf` table called `licor_data`, and shows how to rename a few
...
# Rename columns in `licor_data`
for (i in seq_along(to_rename)) {
  licor_data <-
    rename_col(licor_data, names(to_rename)[i], to_rename[[i]])
}
```
