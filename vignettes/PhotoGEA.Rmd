...
window. See the
[Analyzing C3 A-Ci Curves](web_only/analyzing_c3_aci_curves.html#input-files)
...
- [Publication Gallery](web_only/publications.html): Includes a list of
  publications that describe or use `PhotoGEA`, along with links to their
