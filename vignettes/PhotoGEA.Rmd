...
licor_data <- calculate_temperature_response_arrhenius(licor_data, c3_arrhenius_bernacchi)
...
associated confidence intervals. Here is an example showing values of `Tp`, the
