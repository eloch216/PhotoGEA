...
- `apply_gm`: Calculates values of the chloroplast or mesophyll CO~2~
  concentration.
- `calculate_temperature_response_arrhenius`: Calculates temperature-dependent values of
...
- `calculate_RL_laisk`: Estimates `RL` from a set of response curves using the
  Laisk method.
