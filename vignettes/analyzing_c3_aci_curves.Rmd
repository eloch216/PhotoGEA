...
Comparing these plots with the ones in [Plotting the _A-C~i~_ Curves], it seems that
the unstable points correspond with some of the "odd-looking" points in the _A-C~i~_
