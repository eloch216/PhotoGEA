...
values of the potential limiting rates `Ac`, `Aj`, and `Ap`. We can also take a
look at these, although they make the plots a bit busy. We can also choose to
plot assimilation against `Cc` rather than `Ci`:
