c3_arrhenius_bernacchi <- list(
    ...
    Kc =         list(c = 38.05, Ea = 79.43, units = 'micromol mol^(-1)'),
    Ko =         list(c = 20.30, Ea = 36.38, units = 'mmol mol^(-1)'),
    J_norm =     list(c = 17.57, Ea = 43.5,  units = 'normalized to J at 25 degrees C')
)
